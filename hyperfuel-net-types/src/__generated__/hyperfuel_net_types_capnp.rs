...
// DO NOT EDIT.
// source: hyperfuel_net_types.capnp
...
pub mod query_response_data {
    ...
    impl<'a> Reader<'a> {
        ...
        #[inline]
        pub fn get_receipts(self) -> ::capnp::Result<::capnp::data::Reader<'a>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(
        ...
        #[inline]
        pub fn get_outputs(self) -> ::capnp::Result<::capnp::data::Reader<'a>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(
    ...
    impl<'a> Builder<'a> {
        ...
        #[inline]
        pub fn get_receipts(self) -> ::capnp::Result<::capnp::data::Builder<'a>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        #[inline]
        pub fn set_receipts(&mut self, value: ::capnp::data::Reader<'_>) {
            self.builder.reborrow().get_pointer_field(2).set_data(value);
        }
        #[inline]
        pub fn init_receipts(self, size: u32) -> ::capnp::data::Builder<'a> {
        ...
        #[inline]
        pub fn get_outputs(self) -> ::capnp::Result<::capnp::data::Builder<'a>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
        ...
        #[inline]
        pub fn set_outputs(&mut self, value: ::capnp::data::Reader<'_>) {
            self.builder.reborrow().get_pointer_field(4).set_data(value);
        }
        #[inline]
        pub fn init_outputs(self, size: u32) -> ::capnp::data::Builder<'a> {
    ...
    mod _private {
        pub static ENCODED_NODE: [::capnp::Word; 98] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(104, 121, 112, 101, 114, 102, 117, 101),
            ::capnp::word(108, 95, 110, 101, 116, 95, 116, 121),
        ...
        pub static MEMBERS_BY_NAME: &[u16] = &[0, 3, 4, 2, 1];
...
pub mod query_response {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_data(
            self,
        ) -> ::capnp::Result<crate::hyperfuel_net_types_capnp::query_response_data::Reader<'a>>
        {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::None,
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn get_data(
            self,
        ) -> ::capnp::Result<crate::hyperfuel_net_types_capnp::query_response_data::Builder<'a>>
        {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(
                self.builder.get_pointer_field(0),
                ::core::option::Option::None,
        ...
        pub fn set_data(
            &mut self,
            value: crate::hyperfuel_net_types_capnp::query_response_data::Reader<'_>,
        ) -> ::capnp::Result<()> {
        ...
        pub fn init_data(
            self,
        ) -> crate::hyperfuel_net_types_capnp::query_response_data::Builder<'a> {
    ...
    impl Pipeline {
        pub fn get_data(&self) -> crate::hyperfuel_net_types_capnp::query_response_data::Pipeline {
